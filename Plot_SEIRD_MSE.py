...
# Load the MSE files
mse_file_1 = np.load('Data/mse_Fex_SEIRD.npy')
mse_file_2 = np.load('Data/mse_RNN_SEIRD.npy')
mse_file_3 = np.load('Data/mse_NN_SEIRD.npy')
conf_interval_1 = np.load('Data/modified_mse_FEX_SEIRD.npy')
conf_interval_2 = np.load('Data/modified_mse_RNN_SEIRD.npy')
conf_interval_3 = np.load('Data/modified_mse_NN_SEIRD.npy')
...
plt.savefig('Plot/MSE_SEIRD_250.png', dpi=500, bbox_inches="tight")
