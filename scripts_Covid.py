...
for i in range(1):
    for dim in [3]:
        gpu = 0
        whichDim = 0
        os.system('python controller_covid.py --epoch 100 --bs 10  --greedy 0.1 --gpu '+str(gpu)+' --ckpt Dim'+str(whichDim)+' --tree depth2_rmu3 --random_step 3 --lr 0.002 --dim '+str(dim)+' --base 200000 --left -1 --right 1 --domainbs 5000 --bdbs 1000')
